...
// TS version remove clinical trial per IRB request 
...
const DisclaimerText: React.FC = () => {
  return (
    <div className="text-justify">
      ...
      <p>
        The purpose of this trial is to evaluate the effectiveness of visual therapy in stabilizing tremors in
      ...
      <p>
        Your participation in this trial is entirely voluntary. You may withdraw from the study at any time
      ...
      <p>
        ...
        participate in this  trial and consent to the collection and use of your data as described.
      </p>
      <p>
