...
const ThirdPartyAuthPanel: React.FC<ThirdPartyAuthPanelProps> = ({ clearEmailAndPasswordErrors, isRegister }) => {
  const [message, setMessage] = useState<{ message: string; type: 'success' | 'error' | '' }>({ message: '', type: '' });
  const navigate = useNavigate();

  const handleThirdPartyClick = async (provider: any, providerName: string) => {
  ...
  return (
    <div className="space-y-4">
      <ThirdPartyButton
        onClick={() => handleThirdPartyClick(new GoogleAuthProvider(), 'Google')}
      ...
      <ThirdPartyButton
        onClick={() => handleThirdPartyClick(new FacebookAuthProvider(), 'Facebook')}
        className="w-full mt-2 flex items-center justify-center rounded-lg"
        color="bg-blue-700"
      ...
      <ThirdPartyButton
        onClick={() => handleThirdPartyClick(new OAuthProvider('yahoo.com'), 'Yahoo')}
        className="w-full mt-2 flex items-center justify-center rounded-lg"
        color="bg-purple-700"
      ...
      <ThirdPartyButton
        onClick={() => handleThirdPartyClick(new OAuthProvider('microsoft.com'), 'Microsoft')}
        className="w-full mt-2 flex items-center justify-center rounded-lg"
        color="bg-green-700"
      ...
      <ThirdPartyButton
        onClick={() => handleThirdPartyClick(new OAuthProvider('apple.com'), 'Apple')}
        className="w-full mt-2 flex items-center justify-center rounded-lg"
        color="bg-black"
      ...
      <ThirdPartyButton
        onClick={() => handleThirdPartyClick(new TwitterAuthProvider(), 'Twitter')}
        className="w-full mt-2 flex items-center justify-center rounded-lg"
        color="bg-teal-400"
