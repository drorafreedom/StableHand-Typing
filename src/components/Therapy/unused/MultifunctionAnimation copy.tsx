// src/components/TherapyPage/MultifunctionAnimation.jsx
 ...
 // final working without white trail!! 
 ...
 let x = 0;
  ...
  const sketch = (p5) => {
    ...
    p5.setup = () => {
      ...
      //p5.background(p5.color(settings.bgColor));  //if not disabled when clicking on the menu the white trail pop up  else doesnt matter 
    ...
    p5.draw = () => {
      ...
      const oscillationAmplitudeX = settings. oscillationRange*3 ;
      const oscillationAmplitudeY = settings. oscillationRange *3;
      ...
      switch (settings.direction) {
        ...
        case 'right':
          ...
          case 'oscillateUpDown':
            yOffset =centerY+ oscillationAmplitudeY * p5.sin(time)*2 ; // Divide time for slower oscillation
            time += settings.speed/10; // Adjust speed increment for smoother oscillation
            break;
          case 'oscillateRightLeft':
            x = settings.amplitude+oscillationAmplitudeX * p5.sin(time); // Divide time for slower oscillation
            time += settings.speed/ 5; // Adjust speed increment for smoother oscillation
            break;
        case 'circular':
    ...
    //*********************************************************** */
      // Draw an outline around the canvas which is the only factor that changed the white trail!!!!
      p5.strokeWeight(1);
...
//_____________________ should I put it ?
  useEffect(() => {
    startAnimation();
  }, []);
