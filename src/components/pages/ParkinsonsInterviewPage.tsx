...
// src/components/pages/ParkinsonsInterviewPage.tsx
...
const ParkinsonsInterviewPage: React.FC = () => {
  ...
  const handleNextPage = () => {
    ...
    questions.slice(startIndex, endIndex).forEach((_, index) => {
          ...
          <div className="grid grid-cols-1 justify-center">
            ...
            <div className="flex justify-between mt-4">
              {currentPage > 0 && (
                <button
                  type="button"
                  className="bg-gray-500 rounded-md hover:bg-gray-700 border border-gray-700 px-4 py-2"
              ...
              {currentPage < totalPages - 1 && (
                <button
                  type="button"
                  className="bg-blue-500 rounded-md hover:bg-blue-700 border border-blue-700 px-4 py-2"
              ...
              {currentPage === totalPages - 1 && (
                <button
                  type="submit"
                  className="bg-green-500 rounded-md hover:bg-green-700 border border-green-700 px-4 py-2"
                >
                  Submit
                </button>
              )}
