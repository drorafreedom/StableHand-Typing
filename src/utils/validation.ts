...
export const validateRequired = (value: string | string[]): string[] => {
...
//---------------------------------------validateAgeWithDOB
/* export const validateAgeWithDOB = (dob: string, age: number): string[] => {
  const errors: string[] = [];
...
export const validateAgeWithDOB = (age: number, dob: string): string[] => {
  const errors: string[] = [];
  if (dob) {
    const birthDate = new Date(dob);
    const today = new Date();
